WITH 
unpivot_alias AS (
    UNPIVOT {{ref('stg_labor__number_of_employed_persons')}}
    ON 
        1994,
        1995,
        1996,
    ...
    INTO
        NAME year
        VALUE number_of_employed_persons
)
SELECT 
    ...
    unpivot_alias.number_of_employed_persons as number_of_employed_persons
FROM unpivot_alias
LEFT JOIN
