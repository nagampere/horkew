SELECT
    ...
    mrt_growth.section_id || ':' || mrt_growth.section_name as section_id_name,
    ...
    mrt_labor.nominal_costs*1000000 / (mrt_labor.hours_worked*1000) as labor__nominal_wages,
    mrt_labor.hours_worked / mrt_labor.number_of_workers*1000/260 as labor__working_hour,
    mrt_growth.V / mrt_labor.number_of_workers as labor__value_added_per_worker,
