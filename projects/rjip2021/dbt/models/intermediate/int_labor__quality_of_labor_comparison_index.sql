WITH 
unpivot_alias AS (
    UNPIVOT {{ref('stg_labor__quality_of_labor_comparison_index')}}
    ON 
        1994,
        1995,
        1996,
    ...
    INTO
        NAME year
        VALUE quality_of_labor_comparison_index
)
SELECT 
    ...
    unpivot_alias.quality_of_labor_comparison_index as quality_of_labor_comparison_index
FROM unpivot_alias
LEFT JOIN
