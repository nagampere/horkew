WITH 
unpivot_alias AS (
    UNPIVOT {{ref('stg_growth_account__cost_of_capital_patent_share')}}
    ON 
        1994,
        1995,
        1996,
    ...
    INTO
        NAME year
        VALUE cost_of_capital_patent_share
)
SELECT 
    ...
    unpivot_alias.cost_of_capital_patent_share as cost_of_capital_patent_share
FROM unpivot_alias
LEFT JOIN
